...
tinyengine_status convolve_1x1_s8_ch48_fpreq(const q7_t *input, const uint16_t input_x, const uint16_t input_y,
	...
	for (int32_t i_element = 0; i_element < num_elements / 2; i_element++) {
		...
		out = mat_mult_kernel_s8_s16_reordered_ch48_fpreq(kernel, two_column_buffer, output_ch, scales,
