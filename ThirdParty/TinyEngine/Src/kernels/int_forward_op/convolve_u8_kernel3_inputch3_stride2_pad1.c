...
tinyengine_status convolve_u8_kernel3_inputch3_stride2_pad1(const q8_t *input, const uint16_t input_x, const uint16_t input_y, const uint16_t input_ch, const q7_t *kernel,
