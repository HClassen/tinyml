...
static inline void mac_4row_4col_IOHW_forint8w(q31_t* sum, const q7_t* input_0, const q7_t* input_1,
											   const q7_t* input_2, const q7_t* input_3, const q7_t* filter_0,
											   const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3) {
...
static inline void mac_1row_4col_IOHW_forint8w(q31_t* sum, const q7_t* input_0, const q7_t* filter_0,
											   const q7_t* filter_1, const q7_t* filter_2, const q7_t* filter_3) {
	*sum += *input_0++ * *filter_0;
	*sum += *input_0++ * *filter_1;
	*sum += *input_0++ * *filter_2;
...
static inline void group_mac_kernel8_4row_uniweight_reuse_output_input(q31_t* sum_0, q31_t* sum_1, q31_t* sum_2,
																	   q31_t* sum_3, const q7_t* input_0,
																	   const q7_t* input_1, const q7_t* input_2,
																	   const q7_t* input_3, const q7_t* filter) {
	q31_t tmp;
	tmp = 0;
...
static inline void group_mac_kernel4_4row_uniweight_reuse_output_input(q31_t* sum_0, q31_t* sum_1, q31_t* sum_2,
																	   q31_t* sum_3, const q7_t* input_0,
																	   const q7_t* input_1, const q7_t* input_2,
																	   const q7_t* input_3, const q7_t* filter) {
	q31_t tmp;
...
static inline void transpose_depthwise_mac_kernel3_2row_uniweight(q31_t* sum_0, q31_t* sum_1, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
...
static inline void transpose_depthwise_mac_kernel3_1row_uniweight(q31_t* sum_0, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
																  const uint16_t input_width, const uint16_t STRIDE,
																  const uint16_t IN_PAD, const uint16_t OUT_PAD) {
	*sum_0 += im2col_buffer[0] * ksrc_transposed[0];
...
static inline void transpose_depthwise_mac_kernel5_2row_uniweight(q31_t* sum_0, q31_t* sum_1, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
																  const uint16_t input_width, const uint16_t STRIDE,
																  const uint16_t IN_PAD, const uint16_t OUT_PAD) {
	*sum_0 += im2col_buffer[0] * ksrc_transposed[0];
...
static inline void transpose_depthwise_mac_kernel5_1row_uniweight(q31_t* sum_0, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
																  const uint16_t input_width, const uint16_t STRIDE,
																  const uint16_t IN_PAD, const uint16_t OUT_PAD) {
	*sum_0 += im2col_buffer[0] * ksrc_transposed[0];
...
static inline void transpose_depthwise_mac_kernel7_2row_uniweight(q31_t* sum_0, q31_t* sum_1, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
																  const uint16_t input_width, const uint16_t STRIDE,
																  const uint16_t IN_PAD, const uint16_t OUT_PAD) {
	*sum_0 += im2col_buffer[0] * ksrc_transposed[0];
...
static inline void transpose_depthwise_mac_kernel7_1row_uniweight(q31_t* sum_0, const q7_t* im2col_buffer,
																  const q7_t* ksrc_transposed,
																  const uint16_t input_width, const uint16_t STRIDE,
																  const uint16_t IN_PAD, const uint16_t OUT_PAD) {
	*sum_0 += im2col_buffer[0] * ksrc_transposed[0];
...
static inline void assign_sum_to_pointwise_tmp_output_buffer_4row8col_int8(q31_t* out_0, q31_t* out_1, q31_t* out_2,
																		   q31_t* out_3, const q31_t* sum) {
	*out_0++ += sum[0];
	*out_1++ += sum[1];
	*out_2++ += sum[2];
	*out_3++ += sum[3];
...
static inline void assign_sum_to_pointwise_tmp_output_buffer_4row4col_int8(q31_t* out_0, q31_t* out_1, q31_t* out_2,
																		   q31_t* out_3, const q31_t* sum) {
	*out_0++ += sum[0];
	*out_1++ += sum[1];
	*out_2++ += sum[2];
...
static inline void assign_sum_to_group_tmp_output_buffer_4row8col_int8(
	q31_t* out_0, q31_t* out_1, q31_t* out_2, q31_t* out_3, q31_t* out_4, q31_t* out_5, q31_t* out_6, q31_t* out_7,
	const q31_t* sum_0, const q31_t* sum_1, const q31_t* sum_2, const q31_t* sum_3, q31_t* out_max_0, q31_t* out_max_1,
	q31_t* out_max_2, q31_t* out_max_3, q31_t* out_max_4, q31_t* out_max_5, q31_t* out_max_6, q31_t* out_max_7) {
	*out_0++ = sum_0[0];
...
static inline void assign_sum_to_group_tmp_output_buffer_4row16col_int8(
	q31_t* out_0, q31_t* out_1, q31_t* out_2, q31_t* out_3, q31_t* out_4, q31_t* out_5, q31_t* out_6, q31_t* out_7,
	q31_t* out_8, q31_t* out_9, q31_t* out_10, q31_t* out_11, q31_t* out_12, q31_t* out_13, q31_t* out_14,
	q31_t* out_15, const q31_t* sum_0, const q31_t* sum_1, const q31_t* sum_2, const q31_t* sum_3, q31_t* out_max_0,
	q31_t* out_max_1, q31_t* out_max_2, q31_t* out_max_3, q31_t* out_max_4, q31_t* out_max_5, q31_t* out_max_6,
	q31_t* out_max_7, q31_t* out_max_8, q31_t* out_max_9, q31_t* out_max_10, q31_t* out_max_11, q31_t* out_max_12,
	q31_t* out_max_13, q31_t* out_max_14, q31_t* out_max_15) {
	*out_0++ = sum_0[0];
	*out_max_0 = TN_MAX(abs(*out_max_0), abs(sum_0[0]));
	*out_1++ = sum_0[1];
	*out_max_1 = TN_MAX(abs(*out_max_1), abs(sum_0[1]));
