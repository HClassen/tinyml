...
#define unroll_8inch()                                                                                             \
	...
	while (row_count) {                                                                                            \
		...
		q31_t *ksrc2 = ksrc + 4;                                                                                   \
		conv_1stloop_ele() conv_midloop_ptrele() conv_midloop_ptrele() conv_lastloop_ele() mix_assign_requantize() \
			row_count--;                                                                                           \
	}
...
#define unroll_12inch()                                                                                            \
	...
	while (row_count) {                                                                                            \
		...
		q31_t *ksrc2 = ksrc + 6;                                                                                   \
		conv_1stloop_ele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() \
			conv_lastloop_ele() mix_assign_requantize() row_count--;                                               \
	}
...
#define unroll_16inch()                                                                                            \
	...
	while (row_count) {                                                                                            \
		...
		q31_t *ksrc2 = ksrc + 8;                                                                                   \
		conv_1stloop_ele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() \
			conv_midloop_ptrele() conv_midloop_ptrele() conv_lastloop_ele() mix_assign_requantize() row_count--;   \
	}
...
#define unroll_20inch()                                                                                            \
	...
	while (row_count) {                                                                                            \
		...
		q31_t *ksrc2 = ksrc + 10;                                                                                  \
		conv_1stloop_ele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() \
			conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele()                \
				conv_lastloop_ele() mix_assign_requantize() row_count--;                                           \
	}
...
#define unroll_32inch()                                                                                            \
	...
	while (row_count) {                                                                                            \
		...
		conv_1stloop_ele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() \
			conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele()                \
				conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele() conv_midloop_ptrele()            \
					conv_midloop_ptrele() conv_midloop_ptrele() conv_lastloop_ele() mix_assign_requantize()        \
						row_count--;                                                                               \
	}
